package com.example.wetatchwnd;
...
public class WetatchAdapter extends RecyclerView.Adapter<WetatchAdapter.ViewHolder> {

    private final List<CardData> dataSource;                         // Наш источник данных
    ...
    public WetatchAdapter(List<CardData> dataSource) {
    ...
    @NonNull
    @Override
    public WetatchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        CardData item = dataSource.get(position);
